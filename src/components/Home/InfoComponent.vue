    ...
    <section id="#info" class="pb-8 h-full w-full flex justify-center">
        <div
            ...
            <div class="h-full w-11/12 lg:w-11/12 2xl:w-11/12 flex justify-center items-center flex-wrap">
                ...
                <h2 class="w-full text-start text-lg/snug md:text-4xl/snug text-text-secondary">
                    ...just a few clicks away
                </h2>
            </div>
            <div class="h-1/4 w-full py-4 flex justify-center">
                <router-link to="/trips"
                    class="rounded-3xl border-[1px] bg-accent py-2 w-40 text-white text-center font-bold font-sourcecodepro">Trips</router-link>
            </div>
        </div>
